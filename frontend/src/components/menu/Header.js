...
export default function Header({ onCart, totalQty, onMenuClick, onLogout, onLoginClick }) {
    const auth = useAuth();
    return (
                ...
                <div className="container mx-auto px-4 lg:px-6">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-2">
                            {/* Nếu đã đăng nhập: hiện "Chào, username" + nút Đăng xuất */}
                            {auth?.user ? (
                                <>
                                    <span className="sm:inline font-semibold">
                                    ...
                                    <button
                                        ...
                                        className={`${tone.ghost} px-4 py-2 rounded-xl font-semibold flex items-center gap-2`}
                                    >
                                        <LogOut size={20} />
                                    </button>
                                </>
